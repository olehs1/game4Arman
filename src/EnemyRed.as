package  
{
	 ...
	 * @author Oleg Smagnov
	 */
	public class EnemyRed extends FlxSprite implements Enemy
	{
		[Embed(source = "img/enemy/enemyRed.png")] private var ImgEnemy : Class;
		 ...
		 * 
		 * */
		public function EnemyRed(x : Number, y : Number, speedX : Number = 0, speedY : Number = 0, type : String = 'upDown' ) 
		{
			super( x, y);
		...
		public function setSpeedX( speed : Number ):void
		{
			_speedX = speed;
		}
